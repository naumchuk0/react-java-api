            ...
            <Row gutter={16}>
                ...
                >
                    ...
                    <Form.Item
                        ...
                        htmlFor="name"
                        rules={[
                            {required: true, message: 'The field is important!'},
                            {min: 3, message: 'Minimum lenght = 3'},
                        ]}
                    >
                    ...
                    <Form.Item
                        ...
                        rules={[
                            {required: true, message: 'The field is important!'},
                            {min: 10, message: 'Description should be minimum 10 symbols'},
                        ]}
                    >
                        <TextArea/>
                    </Form.Item>
                    ...
                    >
                        ...
                        >
                            <div>
                                <PlusOutlined/>
                                <div style={{marginTop: 8}}>Choose new photo</div>
                            </div>
                        </Upload>
                    </Form.Item>
